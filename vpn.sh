...
gem install lolcat
bash <(curl -Ls https://raw.githubusercontent.com/tanmaysingh3856/vps-shit/main/Pythoninstall)
...
bash <(curl -Ls https://raw.githubusercontent.com/tanmaysingh3856/vps-shit/main/dropbearconfig.sh)
bash <(curl -Ls https://github.com/tanmaysingh3856/vps-shit/raw/main/dropbear.sh)
bash <(curl -Ls https://raw.githubusercontent.com/tanmaysingh3856/vps-shit/main/sshconfig.sh)
bash <(curl -Ls https://raw.githubusercontent.com/tanmaysingh3856/vps-shit/main/dnsdisable.sh)
...
ver=$VERSION_ID
wget https://raw.githubusercontent.com/tanmaysingh3856/UDP/main/udp.sh && chmod +x udp.sh && ./udp.sh && rm -fr udp.sh
...
wget -O /etc/pam.d/common-password "https://github.com/tanmaysingh3856/last/raw/main/password"
...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/tanmaysingh3856/last/main/nginx.conf
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/tanmaysingh3856/last/main/funnvpn.conf
sed -i "s/xxx/${domain}/g" /etc/nginx/conf.d/funnvpn.conf
wget -O /var/www/html/index.html https://github.com/tanmaysingh3856/tanmaysingh3856.github.io/raw/main/index.html
...
wget -O /home/vps/public_html/index.html "https://github.com/tanmaysingh3856/tanmaysingh3856.github.io/raw/main/index.html"
/etc/init.d/nginx restart

cd /usr/bin
rm -fr menu
rm -fr /usr/sbin/menu
wget https://github.com/tanmaysingh3856/vps-shit/raw/main/menu.zip
unzip menu.zip
rm -fr menu.zip
chmod +x *
clear
cd /usr/local/bin
wget https://github.com/tanmaysingh3856/vps-shit/raw/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/tanmaysingh3856/last/main/service.zip
unzip service.zip
rm -fr service.zip
...
rm acme.sh
cd .acme.sh
bash acme.sh --register-account -m rere@xyz.com
bash acme.sh --issue --standalone -d $domain --force
bash acme.sh --installcert -d $domain --fullchainpath /etc/xray/xray.crt --keypath /etc/xray/xray.key
wget -O /etc/xray/config.json https://raw.githubusercontent.com/tanmaysingh3856/last/main/config.json
